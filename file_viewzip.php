        ...
        if ($dir == null || $name == null || !is_file(processDirectory($dir . '/' . $name))) {
            ...
            if (!$lists) {
                ...
                if ($path != null) {
                    ...
                    echo '<li class="normal">
                        <img src="https://bkit9x.github.io/images/icon/back.png" style="margin-left: 5px; margin-right: 5px"/> 
                        <a href="' . $back . '">
                ...
                if ($count <= 0) {
                    echo '<li class="normal"><img src="https://bkit9x.github.io/images/icon/empty.png"/> <span class="empty">Không có thư mục hoặc tập tin</span></li>';
                } else {
                    foreach ($arrays AS $key => $value) {
                        ...
                        if ($value['folder']) {
                            echo '<li class="folder">
                                <div>
                                    <img src="https://bkit9x.github.io/images/icon/folder.png" style="margin-left: 5px"/>
                            ...
                            echo '<li class="file">
                                <p>
                                    <img src="https://bkit9x.github.io/images/icon/mime/' . $icon . '.png" style="margin-left: 5px"/>
            ...
            <ul class="list">
                ...
                <li><img src="https://bkit9x.github.io/images/icon/unzip.png"/> <a href="file_unzip.php?dir=' . $dirEncode . '&name=' . $name . $pages['paramater_1'] . '">Giải nén</a></li>
