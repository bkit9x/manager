<?php define('ACCESS', true);
    ...
    if (IS_LOGIN) {
        ...
        if ($dir == null || $name == null || !is_file(processDirectory($dir . '/' . $name))) {
            ...
            <div class="title">Chức năng</div>
            <ul class="list">
                <li><img src="https://bkit9x.github.io/images/icon/edit.png"/> <a href="edit_line.php?dir=' . $dirEncode . '&name=' . $name . $pages['paramater_1'] . '&line=' . $line . $page['paramater_1'] . '">Sửa dòng</a></li>
