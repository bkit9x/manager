<?php define('ACCESS', true);
    ...
    if (IS_LOGIN) {
        ...
        if ($dir == null || $name == null || !is_dir(processDirectory($dir . '/' . $name))) {
            ...
            <div class="title">Chức năng</div>
            <ul class="list">
                <li><img src="https://bkit9x.github.io/images/icon/rename.png"/> <a href="folder_edit.php?dir=' . $dirEncode . '&name=' . $name . $pages['paramater_1'] . '">Đổi tên</a></li>
                <li><img src="https://bkit9x.github.io/images/icon/copy.png"/> <a href="folder_copy.php?dir=' . $dirEncode . '&name=' . $name . $pages['paramater_1'] . '">Sao chép</a></li>
                <li><img src="https://bkit9x.github.io/images/icon/move.png"/> <a href="folder_move.php?dir=' . $dirEncode . '&name=' . $name . $pages['paramater_1'] . '">Di chuyển</a></li>
                <li><img src="https://bkit9x.github.io/images/icon/delete.png"/> <a href="folder_delete.php?dir=' . $dirEncode . '&name=' . $name . $pages['paramater_1'] . '">Xóa</a></li>
                <li><img src="https://bkit9x.github.io/images/icon/access.png"/> <a href="folder_chmod.php?dir=' . $dirEncode . '&name=' . $name . $pages['paramater_1'] . '">Chmod</a></li>
