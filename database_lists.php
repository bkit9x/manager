    ...
    if (IS_LOGIN) {
        ...
        if (IS_CONNECT && IS_DATABASE_ROOT) {
            if (isset($_GET['action']) && $_GET['action'] == 'delete') {
                ...
                echo '<ul class="list">
                    <li><img src="https://bkit9x.github.io/images/icon/database.png"/> <a href="database_lists.php">Dang sách database</a></li>
                </ul>';
            } else {
                include_once 'header.php';
                ...
                if (is_resource($query)) {
                        ...
                        echo '<li>
                            <p>
                                <a href="database_lists.php?action=delete&name=' . $name . '">
                                    <img src="https://bkit9x.github.io/images/icon/database.png"/>
                                </a>
                    ...
                    <ul class="list">
                        <li><img src="https://bkit9x.github.io/images/icon/database_create.png"/> <a href="database_create.php">Tạo database</a></li>
                    </ul>';
                } else {
                    echo '<div class="title">' . $title . '</div>
