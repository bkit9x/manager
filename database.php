<?php define('ACCESS', true);
    ...
    if (IS_LOGIN) {
        ...
        <div class="tips"><img src="https://bkit9x.github.io/images/icon/tips.png"/> Tên database để trống nếu bạn muốn kết nối vào danh sách database. Nếu bạn không có toàn quyền với mysql hãy nhập tên database</div>
        <div class="title">Chức năng</div>
        <ul class="list">
            <li><img src="https://bkit9x.github.io/images/icon/list.png"/> <a href="index.php">Quản lý tập tin</a></li>
        </ul>';
