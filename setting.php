<?php define('ACCESS', true);
    ...
    if (IS_LOGIN) {
        ...
        <div class="tips"><img src="https://bkit9x.github.io/images/icon/tips.png"/> Mật khẩu để trống nếu không muốn thay đổi, các phân trang để bằng 0 nếu không muốn phân trang</div>
        <div class="title">Chức năng</div>
        <ul class="list">';

        if ($ref != null)
            echo '<li><img src="https://bkit9x.github.io/images/icon/back.png"/> <a href="' . $ref . '">Quay lại</a></li>';
        else
            echo '<li><img src="https://bkit9x.github.io/images/icon/list.png"/> <a href="index.php">Danh sách</a></li>';
