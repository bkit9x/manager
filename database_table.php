        ...
        if (IS_CONNECT && $name != null && ($isTableExists = isTableExists($name))) {
            if (isset($_GET['action']) && trim($_GET['action']) == 'rename') {
                ...
                if (is_resource($query)) {
                    ...
                    while ($assoc = mysql_fetch_assoc($query)) {
                        echo '<li>
                            <p>
                                <img src="https://bkit9x.github.io/images/icon/columns.png"/>
                ...
                <div class="tips">
                    <img src="https://bkit9x.github.io/images/icon/tips.png"/> Ấn tiếp tục để tạo và tạo tiếp, ấn tạo để tạo và về danh sách cột
                </div>';
                ...
                if (is_resource($query) && $count > 0) {
                    ...
                    <div class="tips">
                        <img src="https://bkit9x.github.io/images/icon/tips.png"/> Ấn tiếp tục để tạo và tạo tiếp, ấn tạo để tạo và về danh sách dữ liệu
                    </div>';
                } else if ($count <= 0) {
                    echo '<div class="title"><div class="ellipsis">' . $title . '</div></div>
                    <div class="list">
                ...
                if (isset($_POST['delete']) && $entry != null) {
                    ...
                    foreach ($entrys AS $v) {
                        if (@mysql_num_rows(@mysql_query("SELECT `$key` FROM `$name` WHERE `$key`='" . addslashes($v) ."' LIMIT 1", LINK_IDENTIFIER)) == 0) {
                            ...
                            $listEntryHtml .= '<li><img src="https://bkit9x.github.io/images/icon/rows.png"/> <span>' . $v . '</span></li>';
                        }
                    }
                ...
                if ($count <= 0) {
                    echo '<ul class="list">
                        <li>
                            <img src="https://bkit9x.github.io/images/icon/empty.png"/> Không có dữ liệu
                        </li>
                    </ul>';
                } else {
                    ...
                    while ($assoc = @mysql_fetch_assoc($query))
                        echo '<li>
                            ...
                            <a href="database_table.php?action=edit_data&name=' . $name . DATABASE_NAME_PARAMATER_1 . '&where=' . rawurlencode($assoc[$by]) . $page['paramater_1'] . $order['paramater_1'] . '">
                                <img src="https://bkit9x.github.io/images/icon/rows.png"/>
                            </a>
            ...
            <ul class="list">';
                ...
                if (isset($_GET['action']) == false || (isset($_GET['action']) && $_GET['action'] != 'add_columns'))
                    echo '<li><img src="https://bkit9x.github.io/images/icon/create.png"/> <a href="database_table.php?action=add_columns' . DATABASE_NAME_PARAMATER_1 . '&name=' . $name . '">Tạo cột</a></li>';

                if (isset($_GET['action']) == false || (isset($_GET['action']) && $_GET['action'] != 'add_data'))
                    echo '<li><img src="https://bkit9x.github.io/images/icon/insert_query.png"/> <a href="database_table.php?action=add_data' . DATABASE_NAME_PARAMATER_1 . '&name=' . $name . $page['paramater_1'] . $order['paramater_1'] . '">Tạo dữ liệu</a></li>';

                if (isset($_GET['action']) == false || (isset($_GET['action']) && $_GET['action'] != 'rename'))
                    echo '<li><img src="https://bkit9x.github.io/images/icon/rename.png"/> <a href="database_table.php?action=rename' . DATABASE_NAME_PARAMATER_1 . '&name=' . $name . '">Đổi tên bảng</a></li>';

                if (isset($_GET['action']) == false || (isset($_GET['action']) && $_GET['action'] != 'delete'))
                    echo '<li><img src="https://bkit9x.github.io/images/icon/delete.png"/> <a href="database_table.php?action=delete' . DATABASE_NAME_PARAMATER_1 . '&name=' . $name . '">Xóa bảng</a></li>';

                if (isset($_GET['action']) == false || (isset($_GET['action']) && $_GET['action'] != 'truncate'))
                    echo '<li><img src="https://bkit9x.github.io/images/icon/clear.png"/> <a href="database_table.php?action=truncate&name=' . $name . DATABASE_NAME_PARAMATER_1 . $page['paramater_1'] . $order['paramater_1'] . '">Xóa sạch dữ liệu</a></li>';

                if (isset($_GET['action']) && empty($_GET['action']) == false)
                    echo '<li><img src="https://bkit9x.github.io/images/icon/rows.png"/> <a href="database_table.php?name=' . $name . DATABASE_NAME_PARAMATER_1 . $page['paramater_1'] . $order['paramater_1'] . '">Danh sách dữ liệu</a></li>';

                if (isset($_GET['action']) == false || (isset($_GET['action']) && $_GET['action'] != 'list_struct'))
                    echo '<li><img src="https://bkit9x.github.io/images/icon/columns.png"/> <a href="database_table.php?action=list_struct' . DATABASE_NAME_PARAMATER_1 . '&name=' . $name . '">Danh sách cột</a></li>';

                echo '<li><img src="https://bkit9x.github.io/images/icon/database_table.png"/> <a href="database_tables.php' . DATABASE_NAME_PARAMATER_0 . '">Danh sách bảng</a></li>';

                if (IS_DATABASE_ROOT)
                    echo '<li><img src="https://bkit9x.github.io/images/icon/database.png"/> <a href="database_lists.php">Danh sách database</a></li>';
            ...
            <ul class="list">
                <li><img src="https://bkit9x.github.io/images/icon/database_table.png"/> <a href="database_tables.php' . DATABASE_NAME_PARAMATER_0 . '">Danh sách bảng</a></li>';
            ...
            <div class="title">Chức năng</div>
            <ul class="list">
                <li><img src="https://bkit9x.github.io/images/icon/database.png"/> <a href="database_lists.php">Danh sách database</a></li>
            </ul>';
        } else {
            include_once 'header.php';
            ...
            <div class="title">Chức năng</div>
            <ul class="list">
                <li><img src="https://bkit9x.github.io/images/icon/disconnect.png"/> <a href="database_disconnect.php">Ngắt kết nối database</a></li>
            </ul>';
        }
