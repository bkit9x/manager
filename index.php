<?php
    ...
    if (IS_LOGIN) {
        ...
        if (!IS_INSTALL_ROOT_DIRECTORY) {
                ...
                for ($i = $start; $i < $end; ++$i) {
                    ...
                    if ($lists[$i]['is_directory']) {
                        echo '<li class="folder">
                            <div>
                                ...
                                <a href="folder_edit.php?dir=' . $dirEncode .'&name=' . $name . $pages['paramater_1'] . '">
                                    <img src="https://bkit9x.github.io/images/icon/folder.png"/>
                                </a>
                        ...
                        echo '<li class="file">
                            <p>
                                <input type="checkbox" name="entry[]" value="' . $name . '"/>
                                ' . $edit[0] . '<img src="https://bkit9x.github.io/images/icon/mime/' . $icon . '.png"/>' . $edit[1] . '
                                <a href="edit_text.php?dir=' . $dirEncode . '&name=' . $name . $pages['paramater_1'] . '">' . $name . '</a>
                            </p>
                            <p>
            ...
            <ul class="list">
                <li><img src="https://bkit9x.github.io/images/icon/create.png"/> <a href="create.php?dir=' . $dirEncode . $pages['paramater_1'] . '">Tạo mới</a></li>
                <li><img src="https://bkit9x.github.io/images/icon/upload.png"/> <a href="upload.php?dir=' . $dirEncode . $pages['paramater_1'] . '">Tải lên tập tin</a></li>
                <li><img src="https://bkit9x.github.io/images/icon/import.png"/> <a href="import.php?dir=' . $dirEncode . $pages['paramater_1'] . '">Nhập khẩu tập tin</a></li>
            </ul>';
        }
