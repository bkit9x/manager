    ...
    if (IS_LOGIN) {
        ...
        if (IS_CONNECT) {
            ...
            if (is_resource($query)) {
                ...
                if ($count == 0) {
                    echo '<li class="normal"><img src="https://bkit9x.github.io/images/icon/empty.png"/> <span class="empty">Không có bảng nào</span></li>';
                } else {
                    $total_size = 0;
                        ...
                        echo '<li>
                            <p>
                                <a href="database_table.php?action=rename&name=' . $name . DATABASE_NAME_PARAMATER_1 . '">
                                    <img src="https://bkit9x.github.io/images/icon/database_table.png"/>
                                </a>
                ...
                <ul class="list">
                    <li><img src="https://bkit9x.github.io/images/icon/database_table_create.png"/> <a href="database_table_create.php' . DATABASE_NAME_PARAMATER_0 . '">Tạo bảng</a></li>';
                ...
                <ul class="list">';
                    ...
                    if (IS_DATABASE_ROOT)
                        ...
                        echo '<li><img src="https://bkit9x.github.io/images/icon/disconnect.png"/> <a href="database_disconnect.php">Ngắt kết nối database</a></li>';
