<?php define('ACCESS', true);
    ...
    if (IS_LOGIN) {
        ...
        if ($dir == null || $name == null || !is_file(processDirectory($dir . '/' . $name))) {
            ...
            echo '
            <script>window.location.href = "'. str_replace('edit_text', 'file', $_SERVER['REQUEST_URI']).'";</script>
            ';
        } else {
            $total = 0;
            ...
            <div class="title">Chức năng</div>
            <ul class="list">
                <li><img src="https://bkit9x.github.io/images/icon/edit_text_line.png"/> <a href="edit_text_line.php?dir=' . $dirEncode . '&name=' . $name . $pages['paramater_1'] . '">Sửa theo dòng</a></li>
